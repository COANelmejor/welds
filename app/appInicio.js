	var app2 = angular.module('appInicio', [ ]);
	//Botones para el nav
	app.controller('contentFirst', function(){
		this.primero = sec1;	
	})
	var sec1 = {
	...
	var sec3 = {
		"lista":[
			"Graduación en reconocida por el US Departmet of Education",
			"Entrar a Universidades Americanas",
			"Cursos en Ingles",
			"Plataforma educativa on line con acceso a lecciones exámenes, investigaciones y más"
		],
		"images":[
			"Gorro de graduación. Flat",
			"Bombilla. Flat",
			"Libro. Flat",
			"Lapiz. Flat"
		]
